...
export const COMMANDS: CommandSpec[] = [
  ...
  { id: "preferences", label: "Preferences…", category: "File", keys: "Ctrl+,", scope: "global", enable: "workspace" },
  ...
  { id: "redo", label: "Redo", category: "Edit", keys: "Ctrl+Y", scope: "global", enable: "redo" },
  { id: "copy", label: "Copy", category: "Edit", keys: "Ctrl+C", scope: "editor", enable: "sel" },
  { id: "paste", label: "Paste", category: "Edit", keys: "Ctrl+V", scope: "editor", enable: "active" },
  ...
  { id: "order-front", label: "Bring Forward", category: "Arrange", keys: null, scope: "editor", enable: "sel" },
  { id: "order-back", label: "Send Backward", category: "Arrange", keys: null, scope: "editor", enable: "sel" },

  // View
  { id: "zoom-fit", label: "Fit", category: "View", keys: "Ctrl+0", scope: "global", enable: "active" },
  { id: "zoom-fit-selection", label: "Fit Selection", category: "View", keys: "Ctrl+Shift+0", scope: "global", enable: "sel" },
  { id: "zoom-100", label: "100%", category: "View", keys: "Ctrl+1", scope: "global", enable: "active" },
  ...
  // Tools (Godot-style single keys)
  { id: "tool-select", label: "Select", category: "Tools", keys: "Q", scope: "editor", enable: "active" },
  { id: "tool-move", label: "Move", category: "Tools", keys: "W", scope: "editor", enable: "active" },
  { id: "tool-rotate", label: "Rotate", category: "Tools", keys: "E", scope: "editor", enable: "active" },
  { id: "tool-scale", label: "Scale", category: "Tools", keys: "R", scope: "editor", enable: "active" },
  { id: "tool-vertex", label: "Vertex", category: "Tools", keys: "T", scope: "editor", enable: "active" },
  { id: "tool-pen", label: "Pen", category: "Tools", keys: "P", scope: "editor", enable: "active" },
  { id: "tool-measure", label: "Measure", category: "Tools", keys: "M", scope: "editor", enable: "active" },
