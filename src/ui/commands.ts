...
export const COMMANDS: CommandSpec[] = [
  ...
  { id: "zoom-in", label: "Zoom In", category: "View", keys: "Ctrl+=", scope: "global", enable: "active" },
  { id: "zoom-out", label: "Zoom Out", category: "View", keys: "Ctrl+-", scope: "global", enable: "active" },
  ...
  { id: "view-cycle", label: "Cycle View Mode", category: "View", keys: "F", scope: "editor", enable: "active" },
  { id: "view-toggle-last", label: "Toggle Last View Mode", category: "View", keys: "Shift+F", scope: "editor", enable: "active" },
