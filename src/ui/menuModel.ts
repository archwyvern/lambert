  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { label: "Deselect", shortcut: keys("deselect"), enabled: hasSel, run: () => action("deselect") },
        { separator: true },
    ...
    },
    {
      ...
      items: [
        ...
        { separator: true },
        { label: "Bring to Front", shortcut: keys("order-top"), enabled: hasSel, run: () => action("order-top") },
        { label: "Bring Forward", shortcut: keys("order-front"), enabled: hasSel, run: () => action("order-front") },
        { label: "Send Backward", shortcut: keys("order-back"), enabled: hasSel, run: () => action("order-back") },
        { label: "Send to Back", shortcut: keys("order-bottom"), enabled: hasSel, run: () => action("order-bottom") },
      ],
    },
    {
      label: "&&View",
